...
<body>
	...
	<div class="entry-content">
		<div class="row-fluid">
			<div class="span6">
				<p><span style="font-weight:bold"> Hangar Servicios </span> <s:message code="text.company.aboutUs.p1"/>
				</p>
				<p><span style="font-weight:bold"> Hangar Servicios </span><s:message code="text.company.aboutUs.p2"/>
				</p>
				<div class="panel">
			...
			<div class="row-fluid">
				<div class="span6">
					<div class="titleborder"><div><s:message code="menu.company.knowHow"/>-<s:message code="title.company.knowHow"/></div></div>
						<p> <span style="font-weight:bold"> Hangar Servicios </span> <s:message code="text.company.knowHow.p1"/>
						</p>
				...
				<div class="row-fluid">
					<div class="span6">
						...
						<p><span style="font-weight:bold"> Hangar Servicios </span> <s:message code="text.company.experience.p1"/>
						</p>
						<p><s:message code="text.company.experience.p2"/></p>                
					</div>
					<div class="span6">
						<div class="titleborder"><div><s:message code="title.company.intheworld"/></div></div>
						<p> <span style="font-weight:bold"> Hangar Servicios </span> <s:message code="text.company.intheworld.p1"/> 
						</p>
				...
				<A name="quality"></A>
					...
					<div align="left" style="float: left; margin: 6px 35px 0px 3px;" >
						...
						<div align="left">
							<a href="resources/pdf/certificado_ISO.pdf" target="_blank" span class="click">Descargar</a>
						</div>
					</div>					
					<p><span style="font-weight:bold"> Hangar Servicios </span> <s:message code="text.company.quality.p1"/></p>										
					<p><span style="font-weight:bold"> Hangar Servicios S.A </span> <s:message code="text.company.quality.p2"/></p>
					<br/>
