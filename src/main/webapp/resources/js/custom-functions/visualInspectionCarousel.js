jQuery(document).ready(function($){
	var options = {
        ...
        function DisplayHideArrow1(index) {
        	...
        	jQuery(".procedures .jssora02l").css("visibility", hideLeftArrow ? "hidden" : "visible");
        	jQuery(".procedures .jssora02r").css("visibility", hideRightArrow ? "hidden" : "visible");
        }
        ...
        function DisplayHideArrow2(index) {
        	...
        	jQuery(".systems .jssora02l").css("visibility", hideLeftArrow ? "hidden" : "visible");
        	jQuery(".systems .jssora02r").css("visibility", hideRightArrow ? "hidden" : "visible");
        }
        ...
        function DisplayHideArrow3(index) {
        	...
        	jQuery(".objetives .jssora02l").css("visibility", hideLeftArrow ? "hidden" : "visible");
        	jQuery(".objetives .jssora02r").css("visibility", hideRightArrow ? "hidden" : "visible");
        }
