	...
	$.ajax({
		...
		success: function(result){
			...
			notice.images.forEach(function(image,index){
				var newIndicator = '';
				var newImage = '';
				var newDiv = '<div id="div'+index+'" align="center"></div>';
				newThumb = '<img u="thumb" src="data:image/png;base64,'+image.image+'"" />';
				newImage = '<img u="image" src="data:image/png;base64,'+image.image+'"" />';
				$('#mainImages').append(newDiv);
				$('#div'+index).append(newImage);	
