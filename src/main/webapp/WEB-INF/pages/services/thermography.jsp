...
jQuery(document).ready(function(){
	...
	<div class="row-fluid container margintop-50">
		...
		<div id='content'>
		<div id="thermography-content" class="span9" style="margin-left:20px;">
		...
		<div id="equipment-content" class="span8 hidden" style="margin-left:20px;margin-right: 20px;width: 53%">
		...
		<div id="equipment-images" class="hidden">
			<img  src="resources/img/termografia/equipamiento/FLIR2.jpg" style="margin-top: 30px" class="margintop-15"/>
		</div>	
		</div>
	</div>
	<br>
	...
	<div id="slider1_container" class="gallery thermography" align="center" style="background-color: white;position: relative; top: 0px; left: 0px; width: 1040px; height: 502px; overflow: hidden; ">
        ...
        <div u="slides" align="center" style="cursor: move; left: 0px; top: 0px; width: 1040px; height: 502px; overflow: hidden;">
            <div align="center">
                <img u="image" src="<s:message code="thermography.img1"></s:message>" />
                <img u="thumb" src="<s:message code="thermography.img1"></s:message>" />
            </div>
            <div align="center">
                <img u="image" src="<s:message code="thermography.img2"></s:message>" />
                <img u="thumb" src="<s:message code="thermography.img2"></s:message>" />
            </div>
            <div align="center">
                <img u="image" src="<s:message code="thermography.img3"></s:message>" />
                <img u="thumb" src="<s:message code="thermography.img3"></s:message>" />
            </div>
        </div>
